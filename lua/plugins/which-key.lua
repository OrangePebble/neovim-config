		...
		which_key.setup({
			...
			spec = {
				...
				-- Around/Inside with mini.ai
				{
					...
					{ "ab", desc = "[]|()|{}", icon = "" },
					{ "ib", desc = "[]|()|{}", icon = "" },
					{ "aw", desc = "Word", icon = { icon = "", color = "grey" } },
					{ "iw", desc = "Word", icon = { icon = "", color = "grey" } },
					{ "aW", desc = "WORD", icon = { icon = "", color = "grey" } },
					{ "iW", desc = "WORD", icon = { icon = "", color = "grey" } },
					{ "ap", desc = "Paragraph", icon = { icon = "󰉢", color = "grey" } },
					{ "ip", desc = "Paragraph", icon = { icon = "󰉢", color = "grey" } },
					{ "as", desc = "Sentence", icon = { icon = ".", color = "grey" } },
					{ "is", desc = "Sentence", icon = { icon = ".", color = "grey" } },
					{ "at", desc = "Tag block", icon = { icon = "󰗀", color = "grey" } },
					{ "it", desc = "Tag block", icon = { icon = "󰗀", color = "grey" } },
					{ "a<Space>", desc = "󱁐", icon = "" },
					{ "i<Space>", desc = "󱁐", icon = "" },
					{ "a*", desc = "*", icon = "" },
					{ "i*", desc = "*", icon = "" },
					...
					{ "ia", desc = "Argument", icon = { icon = "󰊕", color = "grey" } },
					{
						mode = { "n", "o", "x" },
						...
						{ "g[[", desc = "[]", icon = "" },
						{ "g[b", desc = "[]|()|{}", icon = "" },
						{ "g[w", desc = "Word", icon = { icon = "", color = "grey" } },
						{ "g[W", desc = "WORD", icon = { icon = "", color = "grey" } },
						{ "g[p", desc = "Paragraph", icon = { icon = "󰉢", color = "grey" } },
						{ "g[s", desc = "Sentence", icon = { icon = ".", color = "grey" } },
						{ "g[t", desc = "Tag block", icon = { icon = "󰗀", color = "grey" } },
						{ "g[<Space>", desc = "󱁐", icon = "" },
						{ "g[*", desc = "*", icon = "" },
					...
					{
						{ "al", group = "Last", icon = { icon = "󰉾", color = "red" } },
						{ 'al"', desc = '""', icon = "" },
						{ "al'", desc = "''", icon = "" },
						{ "al`", desc = "``", icon = "" },
						{ "al(", desc = "()", icon = "" },
						...
						{ "al[", desc = "[]", icon = "" },
						{ "alb", desc = "[]|()|{}", icon = "" },
						{ "alw", desc = "Word", icon = { icon = "", color = "grey" } },
						{ "alW", desc = "WORD", icon = { icon = "", color = "grey" } },
						{ "alp", desc = "Paragraph", icon = { icon = "󰉢", color = "grey" } },
						{ "als", desc = "Sentence", icon = { icon = ".", color = "grey" } },
						{ "alt", desc = "Tag block", icon = { icon = "󰗀", color = "grey" } },
						...
						{ "il", group = "Last", icon = { icon = "󰉾", color = "red" } },
						{ 'il"', desc = '""', icon = "" },
						{ "il'", desc = "''", icon = "" },
						{ "il`", desc = "``", icon = "" },
						{ "il(", desc = "()", icon = "" },
						...
						{ "il[", desc = "[]", icon = "" },
						{ "ilb", desc = "[]|()|{}", icon = "" },
						{ "ilw", desc = "Word", icon = { icon = "", color = "grey" } },
						{ "ilW", desc = "WORD", icon = { icon = "", color = "grey" } },
						{ "ilp", desc = "Paragraph", icon = { icon = "󰉢", color = "grey" } },
						{ "ils", desc = "Sentence", icon = { icon = ".", color = "grey" } },
						{ "ilt", desc = "Tag block", icon = { icon = "󰗀", color = "grey" } },
						...
						{ "an[", desc = "[]", icon = "" },
						{ "anb", desc = "[]|()|{}", icon = "" },
						{ "anw", desc = "Word", icon = { icon = "", color = "grey" } },
						{ "anW", desc = "WORD", icon = { icon = "", color = "grey" } },
						{ "anp", desc = "Paragraph", icon = { icon = "󰉢", color = "grey" } },
						{ "ans", desc = "Sentence", icon = { icon = ".", color = "grey" } },
						{ "ant", desc = "Tag block", icon = { icon = "󰗀", color = "grey" } },
						...
						{ "in[", desc = "[]", icon = "" },
						{ "inb", desc = "[]|()|{}", icon = "" },
						{ "inw", desc = "Word", icon = { icon = "", color = "grey" } },
						{ "inW", desc = "WORD", icon = { icon = "", color = "grey" } },
						{ "inp", desc = "Paragraph", icon = { icon = "󰉢", color = "grey" } },
						{ "ins", desc = "Sentence", icon = { icon = ".", color = "grey" } },
						{ "int", desc = "Tag block", icon = { icon = "󰗀", color = "grey" } },
